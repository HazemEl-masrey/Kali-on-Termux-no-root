...
printf "${green}[=] Made By : Hazem El-masrey${reset}\n\n"
printf "${blue}[=] YouTube channel : https://m.youtube.com/c/HazemElmasrey${reset}\n\n"
printf "${blue}[=] Telegram : https://t.me/anonymous20001${reset}\n\n"
printf "${green}[=] installing Nethunter in Termux${reset}\n\n"
sleep 5
clear
